...
import static yunnex.pep.common.constant.Constant.HttpHeader.AUTHORIZATION;

public class HeaderSessionManager extends DefaultSessionManager implements WebSessionManager {

    private static final Logger log = LoggerFactory.getLogger(HeaderSessionManager.class);
    ...
    private void removeSessionIdHeader(HttpServletRequest request, HttpServletResponse response) {
        response.setHeader(AUTHORIZATION, Constant.Security.FLAG_DELETE_ME);
    }
